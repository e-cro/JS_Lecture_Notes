...
//for (fB = 1; fB <= 20; fB++){
//don't need to do it as a loop, just change the variable number value   
/* let fB = 15;
if (fB % 3 == 0 && fB % 5 == 0) {
...
// }
/* GOLD
    - Declare a variable of arr that is initialized as an empty array. If the index of the character in the alphabet array is even, add that character to the variable of arr, and console.log arr. If the index is odd - using string interpolation - consol.log 'the index __ is an odd number.'
...
//     pie.includes('apple') ? console.log(`The ${pie} is a fruit pie!`)
//     : pie.includes('blueberry')?console.log(`The ${pie} is a fruit pie!`)
//     : pie.includes('peach')?console.log(`The ${pie} is a fruit pie!`)
//     : pie.includes('cherry')?console.log(`The ${pie} is a fruit pie!`)
...
//Sean made an example of creating a fruitPie array, and using the pie.includes(fruitPies) and that worked ...I am missing something in the code, though:)
// let pies = ['apple', 'blueberry', 'peach', 'chocolate peanut butter', 'cherry', 'oreo', 'chicken pot', 'shepherd'];
// let fruitPie = ['apple', 'blueberry', 'peach', 'cherry'];
// for (pie of pies){
    //     if(pie.includes(fruitPie)) { 
        //     console.log(`The ${pie} is a fruit pie!`);
        //     } else {
            //     console.log(`The ${pie} is not a fruit pie. :(`);
            //     } 
...
// for(key of obj) {
//     console.log(key);
// }//"TypeError: obj is not iterable" (it is enumerable)
